                                        ...
                                        <tr class="intro-x">
                                            ...
                                            <td class="table-report__action w-40">
                                                @if ($pengajuan->status == 'Diterima')
                                                    <div class="flex items-center text-success"> {{ $pengajuan->status }}
                                                    </div>
                                                @elseif($pengajuan->status == 'Ditolak')
                                                    <div class="flex items-center text-danger"> {{ $pengajuan->status }}
                                                    </div>
                                                @else
                                                    <div class="flex items-center text-warning"> {{ $pengajuan->status }}
                                                    </div>
                                                @endif
                                            </td>
                                            <td class="table-report__action">
                                                <div class="flex justify-center items-center">
                                                    <a class="flex items-center mr-3 text-primary"
                                                        href="/dashboard/admin/{{ $pengajuan->id }}"> <i
                                                            data-lucide="check-square" class="w-4 h-4 mr-1"></i> Detail </a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
